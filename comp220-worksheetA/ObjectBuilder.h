...
public:
	...
	*/
	GameObject* MakeObject(const char * vertexShader, const char * fragmentShader, std::string meshName, std::string diffuseTextureName,
	...
	*/
	GameObject* MakeObject(const char * vertexShader, const char * fragmentShader, std::string meshName, std::string diffuseTextureName, std::string specularTextureName,
						   Material material, glm::vec3 position = glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3 scale = glm::vec3(1.0f, 1.0f, 1.0f));
