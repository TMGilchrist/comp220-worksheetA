...
void MaterialPresets::Init()
{
	...
	deepPurple = Material();
	deepPurple.Init(glm::vec4(37.0 / 255, 5.0 /255, 43.0 / 255, 0.0f), glm::vec4(37.0 / 255, 5.0 / 255, 43.0 / 255, 0.0f), glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), 30);

	metal = Material();
	metal.Init(glm::vec4(1.0f, 1.0f, 1.0f, 0.0f), glm::vec4(0.8f, 0.8f, 0.8f, 0.0f), glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), 25);

	stone = Material();
	stone.Init(glm::vec4(1.0f, 1.0f,1.0f, 1.0f), glm::vec4(0.8f, 0.8f, 0.8f, 1.0f), glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), 20);
}
